...
resetPath = 'C:/Users/Alain/workspace/colorimagiques/webapp/backend/src/routes/reset.js'
products = []
...
fullCode = header + loopCode

with open(resetPath, 'w', encoding='utf-8') as f:
    f.write(fullCode)

print(f'Written {len(products)} products (constraints preserved from existing file)')
