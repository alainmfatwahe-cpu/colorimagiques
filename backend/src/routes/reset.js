...
router.post('/seed-books', async (req, res) => {
  try {
    ...
    const books = [
      ...
      {slug: 'latelier-des-oufs-decores', title: \"L'Atelier des Oufs Decorés\", short_description: \"Livre de coloriage - L'Atelier des Oufs Decorés - 35 pages\", pdf_filename: \"Livre L'Atelier des Oufs Décorés_35 pages.pdf\", page_count: 35, dpi: 300, age_group: '3-5', theme: 'books', badge: 'Populaire', is_featured: true, is_published: true, price_eur: 4.99, price_usd: 5.49},
      {slug: 'latelier-magique-du-pere-noel', title: \"L'Atelier Magique du Père Noel\", short_description: \"Livre de coloriage - L'Atelier Magique du Père Noel - 35 pages\", pdf_filename: \"Livre L'Atelier Magique du Père Noel_35 pages.pdf\", page_count: 35, dpi: 300, age_group: '3-5', theme: 'books', badge: 'Nouveau', is_featured: true, is_published: true, price_eur: 4.99, price_usd: 5.49}
    ];
